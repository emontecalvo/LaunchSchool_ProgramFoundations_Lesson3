...
#  but they can be different objects. The "under the hood" object referred to by a particular named-variable can change depending on what is done to that named-variable.
...
def fun_with_ids
  ...
  # ******************************this section is the initial assignment
...
# ***************************************this is inside a block
    ...
    # *******************re-assignment
    #**************a_outer is a variable that points at an object containing the integer 42
    # ********the line below comment creates a new variable named a_inner which points at whatever object a_outer points at
    ...
    #this is calling the function object_id on whatever a_inner points at and storing the result in a new variable a_inner_id
...
#  parameters and see how even though they are treated in the same 
